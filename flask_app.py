...
import pyrebase
config ={
	"apiKey": "AIzaSyA30Z6m94X_MhNH0AonaqLsbiBX4Cr-f8Q",
  "authDomain": "minorproject-420305.firebaseapp.com",
  "databaseURL": "https://minorproject-420305-default-rtdb.firebaseio.com",
  "projectId": "minorproject-420305",
  "storageBucket": "minorproject-420305.appspot.com",
  "messagingSenderId": "573320493320",
  "appId": "1:573320493320:web:2c9626a80efab53b3454bd"
}
firebase = pyrebase.initialize_app(config)
auth = firebase.auth()


pusher = Pusher(app_id='1787620', key='7a0b9412f242ace29544', secret='c5cabe6856b19d775028', cluster='ap2')
app = Flask(__name__)
	...
	if(request.method=='POST'):
		if(request.form['key']=="default"):
			...
			if(request.form['but_type']=="sub"):
				...
				#r=requests.get('localhost:3001/url')
				data = r.json()
				otp_gen = data['otp']
				print (otp_gen)
